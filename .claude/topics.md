# FinFinder Blog Topics Queue

Status legend: `[ ]` = available, `[x]` = published, `[~]` = in progress

## Fin Setup & Configuration
- [x] Twin Fins Are Back: Why the Retro Setup Is Dominating Small Wave Lineups
- [x] The 2+1 Setup: When a Single Fin Meets Side Bites and Why It Works
- [x] Five-Fin Boxes Explained: How to Get Three Boards From One
...
- [x] John John Florence's Fin Setup: Breaking Down What the Best Surfer Rides
- [x] Why Filipe Toledo Switched Fin Templates Mid-Season and What It Means
...
- [ ] How Board Shapers Think About Fins: Interviews With the People Who Design Your Ride
